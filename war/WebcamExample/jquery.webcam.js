/**
 * jQuery webcam Copyright (c) 2010, Robert Eisele (robert@xarg.org) Dual
 * licensed under the MIT or GPL Version 2 licenses. Date: 09/12/2010
 * 
...
(function($) {
	...
	$.fn.webcam = function(options) {
		...
		var source = '<object id="XwebcamXobjectX" type="application/x-shockwave-flash" data="'
				+ webcam.swffile
				+ '" width="'
				+ webcam.width
				+ '" height="'
